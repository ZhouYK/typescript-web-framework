...
const linkComponent = <P, T = any>(component: ComponentType<P> | ForwardRefExoticComponent<P>) => React.memo(React.forwardRef<T, P>((props, ref) => {
  ...
  if (fieldModel) {
    ...
    controlProps.value = fieldState?.value;
  }

  return <Component {...props} {...controlProps} ref={ref} />;
}));
